...
template class PoweredJointPdf<GslVector, GslMatrix>;
template class PoweredJointPdf<GslNumericVector<libMesh::Number>, GslSparseMatrix<libMesh::Number> >;
template class PoweredJointPdf<libMesh::EigenSparseVector<libMesh::Number>, libMesh::EigenSparseMatrix<libMesh::Number> >;
