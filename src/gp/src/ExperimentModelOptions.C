  ...
  m_option_b_y    (m_prefix + "b_y"    )
{
  ...
  queso_require_not_equal_to_msg(m_env.optionsInputFileName(), std::string(""), "this constructor is incompatible with the abscense of an options input file");
}
  ...
  m_option_b_y    (m_prefix + "b_y"    )
{
  ...
  queso_require_equal_to_msg(m_env.optionsInputFileName(), std::string(""), "this constructor is incompatible with the existence of an options input file");
