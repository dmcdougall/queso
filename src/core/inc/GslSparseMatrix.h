...
#ifndef QUESO_GSL_SPARSE_MATRIX_H
#define QUESO_GSL_SPARSE_MATRIX_H
 ...
 */
template <typename T>
class GslSparseMatrix libmesh_final : public libMesh::SparseMatrix<T>
{
...
public:
   ...
   * \p init(...).
   */
  GslSparseMatrix (const libMesh::Parallel::Communicator & comm
   ...
   * Convenient typedefs
   */
  typedef std::unique_ptr<GslMatrix> DataType;
   ...
   */
  virtual void close () const libmesh_override { const_cast<GslSparseMatrix<T> *>(this)->_closed = true; }
