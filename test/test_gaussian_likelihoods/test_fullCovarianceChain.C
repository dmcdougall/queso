...
public:
  ...
  using QUESO::GaussianLikelihoodFullCovariance<V, M>::evaluateModel;
};
...
public:
  BayesianInverseProblem(unsigned int likelihoodFlag)
  {
    ...
    this->covariance = new QUESO::GslSparseMatrix<libMesh::Number>(this->obsSpace->zeroVector());
  ...
  QUESO::GslSparseMatrix<libMesh::Number> * covariance;
